              ...
              <div className="flex flex-col items-center flex-1">
                <div
                  className={cn(
                    ...
                    isLargeVariant ? "p-4" : "w-10 h-10 border-2",
                    isCompleted && !isLargeVariant && "bg-green-500 border-green-500 text-white",
                ...
                >
                  {(isCurrent || isCompleted) && isLast && isLargeVariant ? (
                    <div className="relative bg-[#DFFFE7] rounded-full p-3.5 border-0">
