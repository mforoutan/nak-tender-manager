                ...
                <Card className="p-0">
                    <CardContent className="px-6 py-8">
                        <p>
                            روند تكميل ثبت نام
                            <br />
                            1) اگر با چنين بخشى همانند عكس زير در داشبورد مواجه شديد، به اين معناست كه اطلاعات شما جهت تاييد براى شركت در معامله كامل نيست. براى اين كار تنها كافى است روى هر يك از اطلاعات درخواست شده كليك نماييد تا وارد صفحه مرتبط به آن شده و اطلاعات درخواستى را تكميل بفرماييد. پس از تكميل اطلاعات، تنها كافى است بر روى دكمه
                            &quot;تكميل ثبت نام و ارسال جهت بررسى&quot;
                            كليك نماييد تا اطلاعات شما ارسال كردند.
                        </p>
                    </CardContent>
                </Card>
