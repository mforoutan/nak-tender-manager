...
export function CountdownCard({ targetDate }: { targetDate: Date | string }) {
    return (
        <Card className="flex-1 p-8 bg-gradient-to-br from-15% from-logo-gradient-1 to-80% to-logo-gradient-2">
            <CardHeader className="p-0 mb-8">
                <p className="py-2.5 px-3 flex gap-5 justify-center font-bold text-white text-lg">
                    <HourglassIcon />
            ...
            <CardFooter className="flex flex-col gap-12 items-center">
                <Button className="bg-white text-black hover:bg-white/90">شرکت در معامله</Button>
